...
import com.example.user.WhoIsSmarter.Model.SportsQuestion;
import com.example.user.WhoIsSmarter.R;
import com.example.user.WhoIsSmarter.SQLite.SportsOpenHepler;

import java.util.Collections;
import java.util.List;

public class SportInfiniteActivity extends AppCompatActivity {
    ...
    public void gameLost() {
        ...
        if (sportList.size() - 1 == qid) {
            Intent intent = new Intent(SportInfiniteActivity.this, GameWonActivity.class);
            intent.putExtra("Score", coinValue);
            startActivity(intent);
        }
    }
