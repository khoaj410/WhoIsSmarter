...
import com.example.user.WhoIsSmarter.SQLite.MusicOpenHelper;

import java.util.Collections;
import java.util.List;

public class MusicNormalActivity extends AppCompatActivity {
        ...
        countDownTimer = new CountDownTimer(22000, 1000) {
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(MusicNormalActivity.this, GameWonActivity.class);
